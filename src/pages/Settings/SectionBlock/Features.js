...
import DrawerIcon from '../Drawers/DrawerIcon'
            ...
            <div className="w-full">
              ...
              <div className='flex flex-col md:flex-row sm:flex-col items-center'>
                ...
                <div className="flex flex-col items-center space-x-2 w-2/3 mt-6 m-3 ">
                      <div onClick={() => showModal(featuresValues.items[0].icon.typeElement, featuresValues.section, 0)} className={`h-10 bg-gray-200 rounded-full dark:bg-gray-700 w-10 m-2 ${sectionEdit === featuresValues.section ? `hover:bg-blue-600` : ''} `}><svg className="w-6 h-6 flex justify-center ml-2 mt-1.5 text-gray-200" xmlns="http://www.w3.org/2000/svg" aria-hidden="true" fill="currentColor" viewBox="0 0 640 512"><path d="M480 80C480 35.82 515.8 0 560 0C604.2 0 640 35.82 640 80C640 124.2 604.2 160 560 160C515.8 160 480 124.2 480 80zM0 456.1C0 445.6 2.964 435.3 8.551 426.4L225.3 81.01C231.9 70.42 243.5 64 256 64C268.5 64 280.1 70.42 286.8 81.01L412.7 281.7L460.9 202.7C464.1 196.1 472.2 192 480 192C487.8 192 495 196.1 499.1 202.7L631.1 419.1C636.9 428.6 640 439.7 640 450.9C640 484.6 612.6 512 578.9 512H55.91C25.03 512 .0006 486.1 .0006 456.1L0 456.1z"/></svg></div>
                ...
                <div className="flex flex-col items-center space-x-2 w-2/3 mt-6 m-3 ">
                      <div onClick={() => showModal(featuresValues.items[1].icon.typeElement, featuresValues.section, 1)} className={`h-10 bg-gray-200 rounded-full dark:bg-gray-700 w-10 m-2 ${sectionEdit === featuresValues.section ? `hover:bg-blue-600` : ''} `}><svg className="w-6 h-6 flex justify-center ml-2 mt-1.5 text-gray-200" xmlns="http://www.w3.org/2000/svg" aria-hidden="true" fill="currentColor" viewBox="0 0 640 512"><path d="M480 80C480 35.82 515.8 0 560 0C604.2 0 640 35.82 640 80C640 124.2 604.2 160 560 160C515.8 160 480 124.2 480 80zM0 456.1C0 445.6 2.964 435.3 8.551 426.4L225.3 81.01C231.9 70.42 243.5 64 256 64C268.5 64 280.1 70.42 286.8 81.01L412.7 281.7L460.9 202.7C464.1 196.1 472.2 192 480 192C487.8 192 495 196.1 499.1 202.7L631.1 419.1C636.9 428.6 640 439.7 640 450.9C640 484.6 612.6 512 578.9 512H55.91C25.03 512 .0006 486.1 .0006 456.1L0 456.1z"/></svg></div>
                ...
                <div className="flex flex-col items-center space-x-2 w-2/3 mt-6 m-3 ">
                      <div onClick={() => showModal(featuresValues.items[2].icon.typeElement, featuresValues.section, 2)} className={`h-10 bg-gray-200 rounded-full dark:bg-gray-700 w-10 m-2 ${sectionEdit === featuresValues.section ? `hover:bg-blue-600` : ''} `}><svg className="w-6 h-6 flex justify-center ml-2 mt-1.5 text-gray-200" xmlns="http://www.w3.org/2000/svg" aria-hidden="true" fill="currentColor" viewBox="0 0 640 512"><path d="M480 80C480 35.82 515.8 0 560 0C604.2 0 640 35.82 640 80C640 124.2 604.2 160 560 160C515.8 160 480 124.2 480 80zM0 456.1C0 445.6 2.964 435.3 8.551 426.4L225.3 81.01C231.9 70.42 243.5 64 256 64C268.5 64 280.1 70.42 286.8 81.01L412.7 281.7L460.9 202.7C464.1 196.1 472.2 192 480 192C487.8 192 495 196.1 499.1 202.7L631.1 419.1C636.9 428.6 640 439.7 640 450.9C640 484.6 612.6 512 578.9 512H55.91C25.03 512 .0006 486.1 .0006 456.1L0 456.1z"/></svg></div>
              ...
              <div className='flex flex-col md:flex-row sm:flex-col items-center'>
                <div className="flex flex-col items-center space-x-2 w-2/3 mt-6 m-3 ">
                      <div onClick={() => showModal(featuresValues.items[3].icon.typeElement, featuresValues.section, 3)} className={`h-10 bg-gray-200 rounded-full dark:bg-gray-700 w-10 m-2 ${sectionEdit === featuresValues.section ? `hover:bg-blue-600` : ''} `}><svg className="w-6 h-6 flex justify-center ml-2 mt-1.5 text-gray-200" xmlns="http://www.w3.org/2000/svg" aria-hidden="true" fill="currentColor" viewBox="0 0 640 512"><path d="M480 80C480 35.82 515.8 0 560 0C604.2 0 640 35.82 640 80C640 124.2 604.2 160 560 160C515.8 160 480 124.2 480 80zM0 456.1C0 445.6 2.964 435.3 8.551 426.4L225.3 81.01C231.9 70.42 243.5 64 256 64C268.5 64 280.1 70.42 286.8 81.01L412.7 281.7L460.9 202.7C464.1 196.1 472.2 192 480 192C487.8 192 495 196.1 499.1 202.7L631.1 419.1C636.9 428.6 640 439.7 640 450.9C640 484.6 612.6 512 578.9 512H55.91C25.03 512 .0006 486.1 .0006 456.1L0 456.1z"/></svg></div>
                ...
                <div  className="flex flex-col items-center space-x-2 w-2/3 mt-6 m-3 ">
                      <div onClick={() => showModal(featuresValues.items[4].icon.typeElement, featuresValues.section, 4)} className={`h-10 bg-gray-200 rounded-full dark:bg-gray-700 w-10 m-2 ${sectionEdit === featuresValues.section ? `hover:bg-blue-600` : ''} `}><svg className="w-6 h-6 flex justify-center ml-2 mt-1.5 text-gray-200" xmlns="http://www.w3.org/2000/svg" aria-hidden="true" fill="currentColor" viewBox="0 0 640 512"><path d="M480 80C480 35.82 515.8 0 560 0C604.2 0 640 35.82 640 80C640 124.2 604.2 160 560 160C515.8 160 480 124.2 480 80zM0 456.1C0 445.6 2.964 435.3 8.551 426.4L225.3 81.01C231.9 70.42 243.5 64 256 64C268.5 64 280.1 70.42 286.8 81.01L412.7 281.7L460.9 202.7C464.1 196.1 472.2 192 480 192C487.8 192 495 196.1 499.1 202.7L631.1 419.1C636.9 428.6 640 439.7 640 450.9C640 484.6 612.6 512 578.9 512H55.91C25.03 512 .0006 486.1 .0006 456.1L0 456.1z"/></svg></div>
                ...
                <div className="flex flex-col items-center space-x-2 w-2/3 mt-6 m-3 ">
                      <div onClick={() => showModal(featuresValues.items[5].icon.typeElement, featuresValues.section, 5)} className={`h-10 bg-gray-200 rounded-full dark:bg-gray-700 w-10 m-2 ${sectionEdit === featuresValues.section ? `hover:bg-blue-600` : ''} `}><svg className="w-6 h-6 flex justify-center ml-2 mt-1.5 text-gray-200" xmlns="http://www.w3.org/2000/svg" aria-hidden="true" fill="currentColor" viewBox="0 0 640 512"><path d="M480 80C480 35.82 515.8 0 560 0C604.2 0 640 35.82 640 80C640 124.2 604.2 160 560 160C515.8 160 480 124.2 480 80zM0 456.1C0 445.6 2.964 435.3 8.551 426.4L225.3 81.01C231.9 70.42 243.5 64 256 64C268.5 64 280.1 70.42 286.8 81.01L412.7 281.7L460.9 202.7C464.1 196.1 472.2 192 480 192C487.8 192 495 196.1 499.1 202.7L631.1 419.1C636.9 428.6 640 439.7 640 450.9C640 484.6 612.6 512 578.9 512H55.91C25.03 512 .0006 486.1 .0006 456.1L0 456.1z"/></svg></div>
        ...
        <>
          ...
          {featuresValues.items.map((feaT, i) =>
            <div key={`dwt-features-${i}`}>
              ...
              <DrawerIcon showModal={showModal} modalValues={feaT.icon} section={sectionEdit} dwi={i} />
            </div>
          )}
