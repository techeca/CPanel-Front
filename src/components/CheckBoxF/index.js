...
export default function CheckBoxF({cb, mustCh, tac}){
  ...
  return(
    <div className="flex items-start">
        ...
        <div className="ml-3 text-sm">
          <label htmlFor="terms" className="font-light text-gray-500 dark:text-gray-300">{cb.accepTerm} <a className="font-medium text-primary-600 hover:underline dark:text-primary-500" onClick={tac}>{cb.linkTermText}</a></label>
        </div>
    </div>
  )
}
